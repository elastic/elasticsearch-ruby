  ...
  module API
    module Encryption
      module Actions
        ...
        # Support terms apply.
        #
        # @option arguments [Boolean] :accept_data_loss Acknowledge that resetting the project encryption key permanently destroys all data
        #  that was encrypted under the current key.
        #  The request fails if this is not set to `true`. (*Required*)
