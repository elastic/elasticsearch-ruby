  ...
  module API
    module Cat
      module Actions
        ...
        # @option arguments [List] :h Comma-separated list of column names to display (options: name, index_patterns, order, version, composed_of)
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-templates.html
        #
