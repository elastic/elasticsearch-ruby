  ...
  module API
    module Cat
      module Actions
        ...
        # @option arguments [List] :h Comma-separated list of column names to display (options: node, id, pid, host, ip, port, attr, value)
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-nodeattrs.html
        #
