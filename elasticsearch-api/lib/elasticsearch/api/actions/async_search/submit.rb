  ...
  module API
    module AsyncSearch
      module Actions
        ...
        # @option arguments [Long] :batched_reduce_size The number of shard results that should be reduced at once on the coordinating node. This value should be used as the granularity at which progress results will be made available.
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/async-search.html
        #
