...
module Elasticsearch
  module API
    module Actions
      ...
      # @option arguments [Double] :min_score Include only documents with a specific `_score` value in the result
      ...
      #
      # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-count.html
      #
      def count(arguments = {})
