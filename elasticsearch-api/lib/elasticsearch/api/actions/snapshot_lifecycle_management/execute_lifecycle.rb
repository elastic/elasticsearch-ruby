  ...
  module API
    module SnapshotLifecycleManagement
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.11/slm-api-execute-lifecycle.html
        #
        def execute_lifecycle(arguments = {})
          request_opts = { endpoint: arguments[:endpoint] || "slm.execute_lifecycle" }

          defined_params = [:policy_id].inject({}) do |set_variables, variable|
