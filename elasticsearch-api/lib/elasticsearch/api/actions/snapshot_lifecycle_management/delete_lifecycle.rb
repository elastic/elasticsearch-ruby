  ...
  module API
    module SnapshotLifecycleManagement
      module Actions
        ...
        #
        # @option arguments [String] :policy_id The id of the snapshot lifecycle policy to remove (*Required*)
        ...
        #
        # @see https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-slm-delete-lifecycle
        #
