  ...
  module API
    module SnapshotLifecycleManagement
      module Actions
        ...
        # @option arguments [Hash] :body The snapshot lifecycle policy definition to register (*Required*)
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-put-policy.html
        #
