  ...
  module API
    module Esql
      module Actions
        ...
        # Support terms apply.
        #
        # @option arguments [String, Array<String>] :name A comma-separated list of dataset names or wildcard patterns. Omit to return all datasets.
        ...
        #
        # @see https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-esql-get-dataset
        #
        def get_dataset(arguments = {})
          request_opts = { endpoint: arguments[:endpoint] || 'esql.get_dataset' }
          ...
          path   = if _name
                     "_query/dataset/#{Utils.listify(_name)}"
                   else
                     '_query/dataset'
                   end
