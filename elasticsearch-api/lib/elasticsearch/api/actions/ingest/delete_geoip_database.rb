  ...
  module API
    module Ingest
      module Actions
        ...
        #
        # @option arguments [String, Array] :id A comma-separated list of geoip database configurations to delete (*Required*)
        ...
        #
        # @see https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-ingest-delete-geoip-database
        #
