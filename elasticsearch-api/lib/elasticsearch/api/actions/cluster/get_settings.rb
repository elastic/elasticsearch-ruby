  ...
  module API
    module Cluster
      module Actions
        ...
        # @option arguments [Boolean] :include_defaults If `true`, also returns the values of all other cluster settings set in the
        ...
        #
        # @see https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-cluster-get-settings
        #
