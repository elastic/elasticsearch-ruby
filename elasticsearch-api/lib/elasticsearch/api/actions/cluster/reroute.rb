  ...
  module API
    module Cluster
      module Actions
        ...
        # @option arguments [List] :metric Limit the information returned to the specified metrics. Defaults to all but metadata *Deprecated*
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-reroute.html
        #
