  ...
  module API
    module Cluster
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/cluster-allocation-explain.html
        #
        def allocation_explain(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers, ["/_cluster/allocation/explain"],
