  ...
  module API
    module Snapshot
      module Actions
        ...
        # @option arguments [Boolean] :wait_for_completion If `false`, the request returns a response as soon as the deletes are scheduled.
        ...
        #  For example, if you make two requests to delete the same snapshot then sometimes all of the post-deletion cleanup work will be associated with the first request, delaying its response, while the second request has no associated post-deletion cleanup work and receives its response as soon as the snapshot has been deleted. Server default: true.
