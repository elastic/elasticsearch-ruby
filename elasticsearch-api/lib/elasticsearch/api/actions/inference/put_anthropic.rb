  ...
  module API
    module Inference
      module Actions
        ...
        #
        # @option arguments [String] :task_type The task type (options: completion)
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-anthropic.html
        #
