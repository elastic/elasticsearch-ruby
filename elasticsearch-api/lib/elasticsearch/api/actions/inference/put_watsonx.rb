  ...
  module API
    module Inference
      module Actions
        ...
        #
        # @option arguments [String] :task_type The task type (options: text_embedding, chat_completion, completion, rerank)
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-watsonx-ai.html
        #
