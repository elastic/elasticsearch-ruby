  ...
  module API
    module Inference
      module Actions
        ...
        #
        # @option arguments [String] :task_type The task type (options: chat_completion, completion, rerank, text_embedding)
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-hugging-face.html
        #
