  ...
  module API
    module Nodes
      module Actions
        ...
        # @option arguments [String] :type The type to sample (default: cpu) (options: cpu, wait, block, gpu, mem)
        # @option arguments [String] :sort The sort order for 'cpu' type (default: total) (options: cpu, wait, block, gpu, mem)
        # @option arguments [Time] :timeout Explicit operation timeout
        # @option arguments [Hash] :headers Custom HTTP headers
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-hot-threads.html
        #
