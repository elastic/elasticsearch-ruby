  ...
  module API
    module Nodes
      module Actions
        ...
        # @option arguments [List] :metric A comma-separated list of metrics you wish returned. Use `_all` to retrieve all metrics and `_none` to retrieve the node identity without any additional metrics. (options: _all, _none, settings, os, process, remote_cluster_server, jvm, thread_pool, transport, http, plugins, ingest, indices, aggregations)
        # @option arguments [Boolean] :flat_settings Return settings in flat format (default: false)
        # @option arguments [Time] :timeout Explicit operation timeout
        # @option arguments [Hash] :headers Custom HTTP headers
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-info.html
        #
        def info(arguments = {})
