  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/xpack-rollup.html
        #
        def downsample(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers, ["/{index}/_downsample/{target_index}"],
                            'indices.downsample')
          )
        end
      end
