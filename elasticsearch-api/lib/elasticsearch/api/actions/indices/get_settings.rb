  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/indices-get-settings.html
        #
        def get_settings(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers,
                            ["/_settings", "/{index}/_settings", "/{index}/_settings/{name}", "/_settings/{name}"], 'indices.get_settings')
          )
        end
      end
    end
