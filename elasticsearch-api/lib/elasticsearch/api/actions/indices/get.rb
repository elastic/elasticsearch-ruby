  ...
  module API
    module Indices
      module Actions
        ...
        # @option arguments [List] :features Return only information on specified index features (options: aliases, mappings, settings)
        # @option arguments [Boolean] :flat_settings Return settings in flat format (default: false)
        # @option arguments [Boolean] :include_defaults Whether to return all default setting for each of the indices.
        # @option arguments [Time] :master_timeout Specify timeout for connection to master
        # @option arguments [Hash] :headers Custom HTTP headers
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-index.html
        #
        def get(arguments = {})
