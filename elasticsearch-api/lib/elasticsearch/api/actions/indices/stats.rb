  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @option arguments [List] :metric Limit the information returned the specific metrics. (options: _all, completion, docs, fielddata, query_cache, flush, get, indexing, mappings, merge, recovery, request_cache, refresh, search, segments, shard_stats, store, translog, warmer, bulk, dense_vector, sparse_vector)
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-stats.html
        #
        def stats(arguments = {})
