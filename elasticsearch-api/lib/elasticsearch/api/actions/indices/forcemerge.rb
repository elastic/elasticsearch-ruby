  ...
  module API
    module Indices
      module Actions
        ...
        # @option arguments [Long] :max_num_segments The number of segments the index should be merged into (default: dynamic)
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-forcemerge.html
        #
