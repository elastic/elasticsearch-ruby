  ...
  module API
    module Indices
      module Actions
        # Unfreeze an index
        #
        # @option arguments [List] :index A comma separated list of indices to remove a block from
        ...
        #
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/unfreeze-index-api.html
        #
