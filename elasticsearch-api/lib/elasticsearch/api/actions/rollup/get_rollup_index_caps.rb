  ...
  module API
    module Rollup
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/rollup-get-rollup-index-caps.html
        #
        def get_rollup_index_caps(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers, ["/{index}/_rollup/data"],
