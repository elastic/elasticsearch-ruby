  ...
  module API
    module SynonymRule
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/put-synonym-rule.html
        #
        def put(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers, ["/_synonyms/{synonyms_set}/{synonym_rule}"],
                            'synonym_rule.put')
          )
        end
      end
