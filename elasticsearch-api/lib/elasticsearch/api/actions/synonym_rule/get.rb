  ...
  module API
    module SynonymRule
      module Actions
        ...
        #
        # @option arguments [String] :synonyms_set The id of the synonym set to retrieve the synonym rule from
        # @option arguments [String] :synonym_rule The id of the synonym rule to retrieve
