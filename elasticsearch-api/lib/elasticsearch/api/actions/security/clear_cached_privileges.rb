  ...
  module API
    module Security
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.12/security-api-clear-privilege-cache.html
        #
        def clear_cached_privileges(arguments = {})
          request_opts = { endpoint: arguments[:endpoint] || "security.clear_cached_privileges" }

          defined_params = [:application].inject({}) do |set_variables, variable|
