  ...
  module API
    module Security
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/security-api-saml-logout.html
        #
        def saml_logout(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers, ["/_security/saml/logout"],
