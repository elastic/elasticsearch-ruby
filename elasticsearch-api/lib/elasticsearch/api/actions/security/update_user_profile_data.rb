  ...
  module API
    module Security
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/security-api-update-user-profile-data.html
        #
        def update_user_profile_data(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers, ["/_security/profile/{uid}/_data"],
