  ...
  module API
    module MachineLearning
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/ml-stop-datafeed.html
        #
        def stop_datafeed(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers, ["/_ml/datafeeds/{datafeed_id}/_stop"],
                            'ml.stop_datafeed')
          )
        end
      end
