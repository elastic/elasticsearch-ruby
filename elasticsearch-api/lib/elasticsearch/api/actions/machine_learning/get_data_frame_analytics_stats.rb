  ...
  module API
    module MachineLearning
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/get-dfanalytics-stats.html
        #
        def get_data_frame_analytics_stats(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers,
                            ["/_ml/data_frame/analytics/_stats", "/_ml/data_frame/analytics/{id}/_stats"], 'ml.get_data_frame_analytics_stats')
          )
        end
      end
    end
