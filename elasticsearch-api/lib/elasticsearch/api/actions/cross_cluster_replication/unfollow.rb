  ...
  module API
    module CrossClusterReplication
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.10/ccr-post-unfollow.html
        #
        def unfollow(arguments = {})
          ...
          Elasticsearch::API::Response.new(
            perform_request(method, path, params, body, headers, ["/{index}/_ccr/unfollow"], 'ccr.unfollow')
          )
        end
      end
    end
