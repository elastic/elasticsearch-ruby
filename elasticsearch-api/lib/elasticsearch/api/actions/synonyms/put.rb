  ...
  module API
    module Synonyms
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/current/put-synonyms.html
        #
        def put(arguments = {})
          ...
          request_opts = { :endpoint => "synonyms.put" }

          defined_params = ["synonyms_set"].inject({}) do |set_variables, variable|
