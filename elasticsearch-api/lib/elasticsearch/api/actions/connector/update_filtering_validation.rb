  ...
  module API
    module Connector
      module Actions
        ...
        # @option arguments [Hash] :body Validation info for the draft filtering rules (*Required*)
        #
        # @see https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-filtering-validation-api.html
        #
