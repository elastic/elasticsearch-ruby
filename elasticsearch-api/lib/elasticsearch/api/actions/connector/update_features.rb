  ...
  module API
    module Connector
      module Actions
        ...
        #
        # @see https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation/operation-connector-update-features
        #
        def update_features(arguments = {})
          ...
          path   = "_connector/#{Utils.listify(_connector_id)}/_features"
