...
## 9.5.0 [elasticsearch-ruby-client-9.5.0-release-notes]

### Features and enhancements [elasticsearch-ruby-client-9.5.0-features-enhancements]
...
## 9.4.0 [elasticsearch-ruby-client-9.4.0-release-notes]

### Features and enhancements [elasticsearch-ruby-client-9.4.0-features-enhancements]
...
[Ruby ES|QL Query Builder](https://github.com/elastic/esql-ruby) [version 0.6.0](https://github.com/elastic/esql-ruby/releases/tag/v0.6.0) has been released. This version adds support for `INLINE_STATS`, `METRICS_INFO`, `PROMQL`, `REGISTERED_DOMAIN`, `SET`, `URI_PARTS`, and `USER_AGENT`.
...
### Features and enhancements [elasticsearch-ruby-client-9.3.2-features-enhancements]
...
Code updated to the latest Elasticsearch 9.3 specification.
...
### Features and enhancements [elasticsearch-ruby-client-9.2.2-features-enhancements]
